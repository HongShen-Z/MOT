...
do
	(
		...
		python3 track.py --name $exp_name --source ~/datasets/MOT/MOT16/train/$i/$i --save-txt --yolo_model ~/.cache/torch/checkpoints/crowdhuman_yolov5m.pt --classes 0 --device $CUDA_VISIBLE_DEVICES
